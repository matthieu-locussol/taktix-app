...
import type { AuthRoomResponse } from 'shared/src/rooms/AuthRoom.ts';
import type { ChatRoomResponse } from 'shared/src/rooms/ChatRoom.ts';
import type { MapRoomResponse } from 'shared/src/rooms/MapRoom.ts';
import type { MapState } from 'shared/src/states/MapState.ts';
import type { Interaction } from 'shared/src/types/Interaction.ts';
import type { ProfessionType } from 'shared/src/types/Profession.ts';
import type { Room as TRoom } from 'shared/src/types/Room.ts';
import type { Direction, Position, SceneData } from 'shared/src/types/SceneData.ts';
...
import { isAuthRoomResponse } from 'shared/src/rooms/AuthRoom.ts';
import { isChatRoomResponse } from 'shared/src/rooms/ChatRoom.ts';
import { isMapRoomResponse } from 'shared/src/rooms/MapRoom.ts';
import { Channel } from 'shared/src/types/Channel.ts';
import { CustomProtocol, Protocol } from 'shared/src/types/Colyseus.ts';
