...
export const TalentIcon = ({ id, ...rest }: TalentIconProps) =>
   ({
      ...
      '2': <StatisticBaseIcon {...rest} path="vitality" color="vitality" type="plus" />,
      '3': <StatisticBaseIcon {...rest} path="strength" color="strength" type="damages" />,
      '4': <StatisticBaseIcon {...rest} path="strength" color="strength" type="damages" />,
      '5': <StatisticBaseIcon {...rest} path="vitality" color="vitality" type="plus" />,
      '7': <StatisticBaseIcon {...rest} path="strength" color="strength" type="percent" />,
      '11': <DefaultIcon {...rest} />,
      '12': <DefaultIcon {...rest} />,
      '13': <DefaultIcon {...rest} />,
      '14': <DefaultIcon {...rest} />,
      ...
      '47': <DefaultIcon {...rest} />,
      '48': <DefaultIcon {...rest} />,
      '49': <StatisticBaseIcon {...rest} path="intelligence" color="intelligence" type="plus" />,
      '50': <StatisticBaseIcon {...rest} path="magicShield" color="magicShield" type="plus" />,
      '51': <StatisticBaseIcon {...rest} path="intelligence" color="intelligence" type="damages" />,
      '52': <StatisticBaseIcon {...rest} path="magicShield" color="magicShield" type="plus" />,
      '53': <StatisticBaseIcon {...rest} path="intelligence" color="intelligence" type="damages" />,
      '54': <StatisticBaseIcon {...rest} path="intelligence" color="intelligence" type="percent" />,
      '55': <DefaultIcon {...rest} />,
      '56': <DefaultIcon {...rest} />,
      '57': <DefaultIcon {...rest} />,
      '58': <DefaultIcon {...rest} />,
      ...
      '110': <StatisticBaseIcon {...rest} path="luck" color="luck" type="plus" />,
      '111': <StatisticBaseIcon {...rest} path="luck" color="luck" type="damages" />,
      '112': <StatisticBaseIcon {...rest} path="evasion" color="evasion" type="plus" />,
      '113': <StatisticBaseIcon {...rest} path="prospect" color="prospect" type="plus" />,
      '114': <StatisticBaseIcon {...rest} path="magicShield" color="magicShield" type="plus" />,
      '115': <StatisticBaseIcon {...rest} path="luck" color="luck" type="percent" />,
      ...
      '140': <StatisticBaseIcon {...rest} path="dexterity" color="dexterity" type="plus" />,
      '141': <StatisticBaseIcon {...rest} path="dexterity" color="dexterity" type="damages" />,
      '142': <StatisticBaseIcon {...rest} path="evasion" color="evasion" type="plus" />,
      '143': <StatisticBaseIcon {...rest} path="dexterity" color="dexterity" type="damages" />,
      '144': <StatisticBaseIcon {...rest} path="evasion" color="evasion" type="plus" />,
      '145': <StatisticBaseIcon {...rest} path="dexterity" color="dexterity" type="percent" />,
      ...
      '234': <StatisticBaseIcon {...rest} path="dexterity" color="dexterity" type="plus" />,
      '235': <StatisticBaseIcon {...rest} path="luck" color="luck" type="plus" />,
      '236': <StatisticBaseIcon {...rest} path="initiative" color="initiative" type="plus" />,
      '237': <StatisticBaseIcon {...rest} path="dexterity" color="dexterity" type="plus" />,
      '238': <StatisticBaseIcon {...rest} path="initiative" color="initiative" type="plus" />,
      '239': <StatisticBaseIcon {...rest} path="intelligence" color="intelligence" type="plus" />,
      '240': <StatisticBaseIcon {...rest} path="luck" color="luck" type="plus" />,
      '241': <StatisticBaseIcon {...rest} path="strength" color="strength" type="plus" />,
      '242': <StatisticBaseIcon {...rest} path="initiative" color="initiative" type="plus" />,
      '243': <StatisticBaseIcon {...rest} path="strength" color="strength" type="plus" />,
      '244': <StatisticBaseIcon {...rest} path="initiative" color="initiative" type="plus" />,
      '245': <StatisticBaseIcon {...rest} path="intelligence" color="intelligence" type="plus" />,
